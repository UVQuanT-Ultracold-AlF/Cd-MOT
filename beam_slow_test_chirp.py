...
s_slower = lambda t : 0.3 if t*time_unit <  delay + 2.5e-3 else 0
# s_slower = 0.5
@lru_cache
def Slow_Beam(det_slower, *args, pol = [0,1,1j], **kwargs):
    ...
    return pylcp.laserBeams([
        {'kvec':np.array([-1, 0., 0.]), 'pol':-1, 'delta':det_slower, 's':s_slower,'wb':slower_beam_width, 'pol_coord':'cartesian'}
