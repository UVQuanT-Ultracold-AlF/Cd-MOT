...
MOT_range = np.arange(-550e6/hertz_unit, 50e6/hertz_unit,float(5e6/hertz_unit))
slower_range = np.arange(-1200e6/hertz_unit, 500e6/hertz_unit,float(25e6/hertz_unit))
